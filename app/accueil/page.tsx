...
const DEPARTEMENTS = ['Hérault', 'Gard', 'Aude', 'Pyrénées-Orientales', 'Vaucluse'];
...
const jsonLd = {
  ...
  areaServed: [
    ...
    ...DEPARTEMENTS.map((d) => ({ '@type': 'AdministrativeArea', name: d })),
  ],
};

export default function AccueilVitrinePage() {
  return (
